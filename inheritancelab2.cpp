/*make a class named fruit with data member to calculate no of fruits in a basket create two other classes namef
apple and mangoes to calculate the number of apples and mangoes in the basdket.Print the no of fruits of each 
type and total no of fruits in the basket*/
#include<iostream>
